function pars = LCM_parameters_collection_mouse(par_fit,C_LNLF,K_deg,K_deg_LNP)
   ...
   %% ****************  Pinocytosis rate for each tissue *********************************************
    ...
    pars.k_tr_mRNA_LV_3 = par_fit(6); % Unit measure: 1/h
    % Phenomenological transition rates between mRNA phases
    pars.k_s_12 = par_fit(7); % from phase 1 to phase 2  % Unit measure: 1/h
    pars.k_s_23 = par_fit(8); % from phase 2 to phase 3  % Unit measure: 1/h
end