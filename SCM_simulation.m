...
%% ************* Source code for the model simulation for both the recombinant and mRNA-encoded protein administration (SCM) *********************
...
% ************************ Fitted parameters ***********************************************
% In the case of the Short Chain Model (SCM) we fit 6 parameters
...
% k_tr_mRNA_LV_1, k_tr_mRNA_LV_2
% the phenomenological transition rate between mRNA phases:
% k_s_12 (from phase 1 to phase 2)
...
% mRNA dose injected - 1.5 mg/Kg -> 1500 mg*0.02 (mouse weight 0.02 Kg)
...
load('SCM_parameters_estimated.mat')
parameters = parameters_estimated;


%% ************************ Specific species parameters for the mRNA and the Protein Transportation modules **************************
% Parameters collection related to the mouse physiology
pars = SCM_parameters_collection_mouse(parameters,C_LNLF,K_deg,K_deg_LNP);
% Parameters collection related to the trasport of 55kDa proteins
...
% the time-evolution of the corresponding quantity
[T_LNP,SV_LNP] = ode15s(@(t,Y) SCM(t,Y,pars,pars_dim), tspan, C0, opt);
