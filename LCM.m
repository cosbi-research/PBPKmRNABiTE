function dydt = LCM(t,y,pars,pars_dim)

%This matlab function contains the equations of the SCM model and the definition of the dynamic parameters
...
%% Concentration of mAb in compartments without absorption and tumour
C_PLASMA = y(46);
C_LYMPH = y(47);
...
%% Concentration of mRNA in plasma and liver
C_mRNA_plasma = y(51);
C_mRNA_liver = y(52);
C_mRNA_liver_2 = y(53);
C_mRNA_liver_3 = y(54);
...
%% Fluxes outgoing from each organ
...
dydt(1) = (M_VI_HEART - Q_VOUT_HEART*C_V_HEART - CL_TP_HEART - CL_UP_HEART*C_V_HEART)/pars.V_V_HEART;
...
dydt(16) = (C_V_HEART + C_I_HEART)*CL_UP_HEART/pars.V_E_HEART - pars.K_deg_LNP*C_E_HEART;
dydt(17) = (C_V_LUNG + C_I_LUNG)*CL_UP_LUNG/pars.V_E_LUNG - pars.K_deg_LNP*C_E_LUNG;
dydt(18) = (C_V_MUSCLE + C_I_MUSCLE)*CL_UP_MUSCLE/pars.V_E_MUSCLE - pars.K_deg_LNP*C_E_MUSCLE;
dydt(19) = (C_V_SKIN + C_I_SKIN)*CL_UP_SKIN/pars.V_E_SKIN - pars.K_deg_LNP*C_E_SKIN;
dydt(20) = (C_V_ADIPOSE + C_I_ADIPOSE)*CL_UP_ADIPOSE/pars.V_E_ADIPOSE - pars.K_deg_LNP*C_E_ADIPOSE;
dydt(21) = (C_V_BONE + C_I_BONE)*CL_UP_BONE/pars.V_E_BONE - pars.K_deg_LNP*C_E_BONE;
dydt(22) = (C_V_BRAIN + C_I_BRAIN)*CL_UP_BRAIN/pars.V_E_BRAIN - pars.K_deg_LNP*C_E_BRAIN;
dydt(23) = (C_V_KIDNEY + C_I_KIDNEY)*CL_UP_KIDNEY/pars.V_E_KIDNEY - pars.K_deg_LNP*C_E_KIDNEY;
dydt(24) = (C_V_LIVER + C_I_LIVER)*CL_UP_LIVER/pars.V_E_LIVER - pars.K_deg_LNP*C_E_LIVER;
dydt(25) = (C_V_SM_INT + C_I_SM_INT)*CL_UP_SM_INT/pars.V_E_SM_INT - pars.K_deg_LNP*C_E_SM_INT;
dydt(26) = (C_V_LG_INT + C_I_LG_INT)*CL_UP_LG_INT/pars.V_E_LG_INT - pars.K_deg_LNP*C_E_LG_INT;
dydt(27) = (C_V_PANCREAS + C_I_PANCREAS)*CL_UP_PANCREAS/pars.V_E_PANCREAS - pars.K_deg_LNP*C_E_PANCREAS;
dydt(28) = (C_V_THYMUS + C_I_THYMUS)*CL_UP_THYMUS/pars.V_E_THYMUS - pars.K_deg_LNP*C_E_THYMUS;
dydt(29) = (C_V_SPLEEN + C_I_SPLEEN)*CL_UP_SPLEEN/pars.V_E_SPLEEN - pars.K_deg_LNP*C_E_SPLEEN;
dydt(30) = (C_V_OTHER + C_I_OTHER)*CL_UP_OTHER/pars.V_E_OTHER - pars.K_deg_LNP*C_E_OTHER;
...
dydt(39) =   CL_TP_LIVER/pars.V_I_LIVER - (1.0-pars.SIGMA_I_LIVER)*pars.L_LIVER*C_I_LIVER/pars.V_I_LIVER - CL_UP_LIVER*(C_I_LIVER)/pars.V_I_LIVER + pars.k_tr_mRNA_LV_1*C_mRNA_liver+pars.k_tr_mRNA_LV_2*C_mRNA_liver_2+pars.k_tr_mRNA_LV_3*C_mRNA_liver_3;
...
dydt(49) = (C_V_TUMOUR + C_I_TUMOUR)*CL_UP_TUMOUR/pars.V_E_TUMOUR - pars.K_deg_LNP*C_E_TUMOUR;
...
%% mRNA
dydt(51) = - pars.k_d_mRNA*C_mRNA_plasma - pars.k_BL2LV*C_mRNA_plasma;
dydt(52) = + pars.k_BL2LV*(1-pars.ratio_in_other)*C_mRNA_plasma*(pars.V_TOT_PLASMA)/pars.V_I_LIVER - pars.k_s_12*C_mRNA_liver - pars.k_d_mRNA*C_mRNA_liver;
dydt(53) = + pars.k_s_12*C_mRNA_liver - pars.k_s_23*C_mRNA_liver_2 - pars.k_d_mRNA*C_mRNA_liver_2;
dydt(54) = + pars.k_s_23*C_mRNA_liver_2 - pars.k_d_mRNA*C_mRNA_liver_3;
end
