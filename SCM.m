function dydt = SCM(t,y,pars,pars_dim)
...
dydt(39) =   CL_TP_LIVER/pars.V_I_LIVER - (1.0-pars.SIGMA_I_LIVER)*pars.L_LIVER*C_I_LIVER/pars.V_I_LIVER - CL_UP_LIVER*(C_I_LIVER)/pars.V_I_LIVER + pars.k_tr_mRNA_LV_1*C_mRNA_liver+pars.k_tr_mRNA_LV_2*C_mRNA_liver_2;
...
dydt(53) = + pars.k_s_12*C_mRNA_liver - pars.k_d_mRNA*C_mRNA_liver_2;
end
